...
mkdir /data/nvme1n1p1/mysql
cat << EOF > ${MYSQL_CONF}
[mysqld]
server-id=123
datadir=/data/nvme1n1p1/mysql
log-bin=/data/nvme1n1p1/mysql/mysql-bin
...
mkdir -p /data/nvme1n1p1/mongodb
chown -R ${MONGO_USER_GROUP}:${MONGO_USER_GROUP} /data/nvme1n1p1/mongodb
...
systemLog:
  ...
  path: /data/nvme1n1p1/mongodb/mongod.log

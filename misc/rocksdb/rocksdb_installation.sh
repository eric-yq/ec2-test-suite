...
LOG_PATH="$HOME/RocksDB_Benchmark_$PN"
mkdir -p $LOG_PATH
...
ACTION="bulkload" && PRINT_INFO "  $ACTION....."
NUM_KEYS=900000000 CACHE_SIZE=6442450944 bash benchmark.sh bulkload

ACTION="readrandom" && PRINT_INFO "  $ACTION....."
NUM_KEYS=900000000 CACHE_SIZE=6442450944 DURATION=5400 bash benchmark.sh readrandom

ACTION="multireadrandom" && PRINT_INFO "  $ACTION....."
NUM_KEYS=900000000 CACHE_SIZE=6442450944 DURATION=5400 bash benchmark.sh multireadrandom --multiread_batched

ACTION="fwdrange" && PRINT_INFO "  $ACTION....."
NUM_KEYS=900000000 CACHE_SIZE=6442450944 DURATION=5400 bash benchmark.sh fwdrange

ACTION="revrange" && PRINT_INFO "  $ACTION....."
NUM_KEYS=900000000 CACHE_SIZE=6442450944 DURATION=5400 bash benchmark.sh revrange

ACTION="overwrite" && PRINT_INFO "  $ACTION....."
NUM_KEYS=900000000 CACHE_SIZE=6442450944 DURATION=5400 bash benchmark.sh overwrite

ACTION="readwhilewriting" && PRINT_INFO "  $ACTION....."
NUM_KEYS=900000000 CACHE_SIZE=6442450944 DURATION=5400 MB_WRITE_PER_SEC=2 bash benchmark.sh readwhilewriting

ACTION="fwdrangewhilewriting" && PRINT_INFO "  $ACTION....."
NUM_KEYS=900000000 CACHE_SIZE=6442450944 DURATION=5400 MB_WRITE_PER_SEC=2 bash benchmark.sh fwdrangewhilewriting

ACTION="revrangewhilewriting" && PRINT_INFO "  $ACTION....."
NUM_KEYS=900000000 CACHE_SIZE=6442450944 DURATION=5400 MB_WRITE_PER_SEC=2 bash benchmark.sh revrangewhilewriting

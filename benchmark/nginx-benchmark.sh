...
do
   ...
   io.write(string.format("RPS=%g , Latency(P50)=%d us, Latency(P90)=%d us, Latency(P99)=%d us, Latency(P99.99)=%d us\n", "rps", latency:percentile(50),latency:percentile(90), latency:percentile(99),latency:percentile(99.99)))
end
EOF
